...
<div class="container mt-4 py-5">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <form method="GET" action="{{ route('requests.catalog') }}" class="card shadow-sm">
                <div class="card-body">
                    <div class="input-group">
                        ...
                        border-bottom-right-radius: 0px !important;" name="search" 
                               placeholder="Поиск по заявкам..." value="{{ request('search') }}">
    ...
    <div class="row">
        ...
        <!-- Фильтры слева -->
        <div class="col-md-3">
            <form id="filter-form" method="GET" action="{{ route('requests.catalog') }}">
                ...
                <div class="card shadow-sm mb-4" style="border: none"> 
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="{{ route('requests.catalog') }}" class="btn btn-outline-secondary">
        ...
        <div class="col-md-9">
            ...
            <nav aria-label="breadcrumb" class="mb-4">
                <ol class="breadcrumb bg-white p-3 shadow-sm rounded">
                    ...
                    <li class="breadcrumb-item active">Каталог заявок</li>
                </ol>
            </nav>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100 shadow-sm">
                        <div class="card-body" style="padding: 10px 1rem">
                            ...
                            <span class="small-text"  style="font-size: 12px;">{{ $request->customer->name}} 
                                ⭐ {{ number_format($request->customer->average_rating, 1) }} ({{ $request->customer->reviews_count }} отзывов)
                            </span>
