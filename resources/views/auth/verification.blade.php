                ...
                <div class="col-lg-4 col-md-8 col-12 mx-auto">
                    <div class="card z-index-0 fadeIn3 fadeInBottom">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center">
                                <span class="change-btn" onclick="toggleForm('changeEmailForm')">Изменить email</span>
                            </div>

                            <form id="changeEmailForm" action="{{ route('change.email') }}" method="post" class="hidden-form">
                                @csrf
                                <div class="input-group is-focused input-group-outline my-3">
                            ...
                            @if(!Auth::user()->phone_verified_at)
                                ...
                                <div class="phone-verification">
                                    ...
                                    <div class="text-center">
                                        <span class="change-btn" onclick="toggleForm('changePhoneForm')">Изменить телефон</span>
                                    </div>

                                    <form id="changePhoneForm" action="{{ route('change.phone') }}" method="post" class="hidden-form">
                                        @csrf
                                        <div class="input-group is-focused input-group-outline my-3">
